...
const CardWithActions = ({
  range, setRange,
  todaySignupUsers, last7dSignupUsers, lastMonthSignupUsers, lastYearSignupUsers,
  growthRate,
  loading, error, className = "",
}) => {
  const value = useMemo(() => {
    switch (range) {
      case "today": return todaySignupUsers ?? 0;
      case "7d":    return last7dSignupUsers ?? 0;
      case "month": return lastMonthSignupUsers ?? 0;
      case "year":
      default:      return lastYearSignupUsers ?? 0;
    }
