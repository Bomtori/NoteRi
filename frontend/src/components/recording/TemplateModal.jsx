    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 z-[60]"
        >
          <div className="bg-white/95 backdrop-blur-md border border-gray-200 shadow-lg rounded-2xl p-4 w-[220px] text-center">
